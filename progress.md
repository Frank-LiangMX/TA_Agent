...
- MCP 集成（mcp.json + UI 管理 + Agent 对话管理 + 热加载 + 测试连接 + 6 个 Agent 工具）
...
| 版本 | 日期 | 关键改动 |
|------|------|---------|
| v0.24 | 05-19 | MCP 集成（mcp.json + UI管理 + Agent管理 + 热加载 + 测试连接）、文档重组（reference/decisions/experiments/guides）、首次引导 + 使用指南、Agent 自我意识、进度追踪 |
