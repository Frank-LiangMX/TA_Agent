...
import * as fflate from 'https://cdn.jsdelivr.net/npm/three@0.170.0/examples/jsm/libs/fflate.module.js';
import { NURBSCurve } from 'https://cdn.jsdelivr.net/npm/three@0.170.0/examples/jsm/curves/NURBSCurve.js';
...
class FBXTreeParser {
	...
	parseSkeleton( relationships, deformerNodes ) {
		...
		relationships.children.forEach( function ( child ) {
			...
			if ( ! boneNode || boneNode.attrType !== 'Cluster' ) return;
	...
	parseMorphTargets( relationships, deformerNodes ) {
		...
		for ( let i = 0; i < relationships.children.length; i ++ ) {
			...
			if ( ! morphTargetNode || morphTargetNode.attrType !== 'BlendShapeChannel' ) return;
